...
interface HexagonProps extends ComponentPropsWithoutRef<'svg'> {
  size?: number;
  reverse?: boolean;
  duration?: number;
}

export default function Hexagon({size = 800, reverse = false, duration = 15, className}: HexagonProps) {
